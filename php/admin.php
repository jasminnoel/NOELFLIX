	...
	$req="SELECT idfilm,titrefilm,catfilm,dureefilm,realfilm,anneefilm,prix,imgfilm FROM films";
	 try{
		 ...
		 while($ligne=mysqli_fetch_object($listeFilms)){
			$rep.="<tr><td>".($ligne->idfilm)."</td><td>".($ligne->titrefilm)."</td><td>".($ligne->catfilm)."</td><td>".($ligne->dureefilm)."</td><td>".($ligne->realfilm)."</td><td>".($ligne->anneefilm)."</td><td>".($ligne->prix)."</td><td><img src='../pochettes/".($ligne->imgfilm)."' width=100px></td></tr>";		 
		}
