...
<body class="bg-dark">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body p-3">
                    <form class="form-signin" id="formconnex" name="formconnex" method="post" action="php/connexion.php">
    ...
    <div class="modal fade" id="modalInscription" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body p-3">
                    <form class="needs-validation" id="formInscription" action="php/adduser.php" method="post" name="formInscription">
                        <h1 class="h3 mb-3 font-weight-normal">NOELFLIX</h1>
                        <div class="mb-3">
